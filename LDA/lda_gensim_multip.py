...
lda = gensim.models.ldamulticore.LdaMulticore(corpus_tfidf, num_topics=100, id2word = dictionary, iterations=20, workers=(num_processors-1))
...
#                workers=2, # minus one because `workers`
#            )
